...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> CustomerExceptionHandler(PaymentException ce, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> ShipperExceptionHandler(ShipperException ce, WebRequest req){
